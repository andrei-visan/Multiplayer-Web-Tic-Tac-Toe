  ...
  <html lang="zxx">
    ...
    <body>
      ...
      <header>
        ...
        <a href="#" class="btn_right">Site statistics</a>
      ...
      <div class="row">
        <div class="column left">
          ...
          <h3> Mouse position heat map on Home screen </h3>
          <table id='mouse_pos_table'> </table>
          <br><br>
          <h3> Top 10 users: </h3>
          <table id='player_table'></table>
          <br>
        </div>
